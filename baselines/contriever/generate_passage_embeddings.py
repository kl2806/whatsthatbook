...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_text", action="store_true", help="title not added to the passage body")
    parser.add_argument("--metadata_field", type=str, default="text", help="metadata field to use for passage")
